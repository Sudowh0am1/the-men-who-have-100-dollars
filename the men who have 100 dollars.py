# this is the Question : there's 50 men who each one has 100 dollar. how much money will remain for each one
# if in every round  they borrow exactly 1 dollar to a random person.
# suppose that we do it for 200 rounds. POINT : the person who has zero money will be omitted. 
